...
local buttons = {
    ...
    solo = {
        { text = "Continue", action = function() gameState = "level" ; level.continue() end },--startLevel(1) end },
        ...
        { text = "New Game", action = function() globalRemoveAllSaves(); gameState = "level" ; level.continue() end },
