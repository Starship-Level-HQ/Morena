...
local buttonConfig = { x = 100, y = 310, width = 200, height = 50 }
local buttonExit = { x = 100, y = 380, width = 200, height = 50 }
...
function menu.load()
    ...
    buttonConfigBackground = generateButtonBackhround(buttonConfig)
