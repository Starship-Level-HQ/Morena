...
function love.draw()
  ...
  -- let's draw our hero
  man = love.graphics.newImage("sprite.png")
  love.graphics.setColor(hero.color1, hero.color2, hero.color3, hero.color4)
  --love.graphics.rectangle("fill", hero.x, hero.y, hero.width, hero.height)
  love.graphics.draw(man, hero.x, hero.y)
...
function shoot()
  ...
  love.audio.play(love.audio.newSource( "shot.wav", "static" ))
end
