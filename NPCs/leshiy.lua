Leshiy = {
  new = function() 
    local self = {}
    self.shape = love.physics.newRectangleShape(68, 175)              --размер коллайдера
    self.width = 64
    self.height = 130
    self.spriteSheet = love.graphics.newImage('res/sprites/leshiy1.png')
    self.grid = anim8.newGrid(46, 82, self.spriteSheet:getWidth(), self.spriteSheet:getHeight())
    self.animations = {}
